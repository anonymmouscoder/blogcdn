...
$(window).scroll(function(){Defer.dom(".lazy",125,"loaded",null,{rootMargin:"1px"}),"undefined"!=typeof infinite_scroll&&infinite_scroll.on("load",function(){Defer.dom(".lazy",125,"loaded",null,{rootMargin:"1px"})}),Defer.dom("iframe.lazy",125,"loaded")}),$(".postEntry img").each(function(){$(this).addClass("lazy");var a=$(this).attr("src"),b=$("title").text();$(this).attr("data-src",a),$(this).attr("src","data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="),$(this).attr("alt",b)});
